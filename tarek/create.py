...
#======================== Starting up and Shutting Down================    
    def __init__(self, startingMode=SAFE_MODE):
...
#==================== Modes ======================    
    ...
    def getAngle(self):
	#self.getSensor( "ANGLE" )
	angle = self.getSensor( "ANGLE" )
	print ('angle = ' +str(angle))

   # def getCharg(self):
	#elf.getSensor( "CHARGING_STATE" )
	#charg = self.getSensor( "CHARGING_STATE" )
	#print ('charging state = ' + str(charg))
